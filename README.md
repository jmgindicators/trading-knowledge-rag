...
[![CI](https://github.com/jmgindicators/trading-knowledge-rag/actions/workflows/ci.yml/badge.svg)](https://github.com/jmgindicators/trading-knowledge-rag/actions/workflows/ci.yml)
...
- **Test suite** of 18 pytest tests covering the ingestion pipeline, retrieval logic, prompt construction, cost calculation, input validation, and end-to-end integration. All external dependencies are mocked so tests are fast, free, and deterministic. Runs automatically on every push and pull request via GitHub Actions CI across Python 3.11, 3.12, and 3.13.
